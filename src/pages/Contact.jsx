    ...
    <div className="font-['Poppins'] bg-gray-50 min-h-screen">
      ...
      <section className="relative min-h-[70vh] sm:min-h-[85vh] flex items-center bg-gradient-to-br from-[#FF5252] via-[#ff4d4d] to-[#d32f2f] text-white overflow-hidden">
        ...
        <div className="absolute inset-0 opacity-30 pointer-events-none">
          <div className="absolute -top-20 -left-20 sm:-top-40 sm:-left-40 w-[300px] xs:w-[400px] sm:w-[500px] md:w-[600px] lg:w-[800px] h-[300px] xs:h-[400px] sm:h-[500px] md:h-[600px] lg:h-[800px] bg-white/40 rounded-full blur-3xl animate-pulse-slow" />
          <div className="absolute -bottom-32 -right-16 sm:-bottom-60 sm:-right-60 w-[400px] xs:w-[500px] sm:w-[600px] md:w-[700px] lg:w-[900px] h-[400px] xs:h-[500px] sm:h-[600px] md:h-[700px] lg:h-[900px] bg-white/30 rounded-full blur-3xl animate-pulse-slow delay-1000" />
        </div>
        ...
        <div className="relative max-w-7xl mx-auto px-4 xs:px-5 sm:px-8 lg:px-12 py-12 xs:py-14 sm:py-16 md:py-20 grid lg:grid-cols-2 gap-8 xs:gap-10 lg:gap-16 items-center z-10">
          ...
          >
            ...
            <p className="mt-4 xs:mt-5 sm:mt-6 text-base xs:text-lg sm:text-xl md:text-2xl max-w-xl mx-auto lg:mx-0 opacity-95">
            ...
            <div className="mt-6 xs:mt-8 sm:mt-10 flex flex-col sm:flex-row gap-3 xs:gap-4 sm:gap-6 justify-center lg:justify-start">
              <a
                href="#contact-form"
                className="bg-black text-white px-6 xs:px-8 sm:px-10 py-3 xs:py-4 sm:py-5 rounded-2xl font-bold text-sm xs:text-base sm:text-lg shadow-2xl hover:bg-gray-900 transition-all duration-300 hover:scale-105 active:scale-95"
              >
                Send Message
              </a>
              <a
                href="tel:+918889990000"
                className="border-2 border-white text-white px-6 xs:px-8 sm:px-10 py-3 xs:py-4 sm:py-5 rounded-2xl font-bold text-sm xs:text-base sm:text-lg hover:bg-white hover:text-[#FF5252] transition-all duration-300 hover:scale-105 active:scale-95"
              >
                Call Us Now
              </a>
            </div>
          ...
          >
            <div className="relative">
              <img
                ...
                className="rounded-3xl shadow-2xl border-8 border-white/25 object-cover h-[400px] md:h-[480px] lg:h-[520px] w-full"
              />
              <motion.div
          ...
          >
            {[
              ...
              <motion.a
                ...
                href={item.link}
                variants={fadeInUp}
                className="bg-gradient-to-br from-gray-50 to-white p-5 xs:p-6 sm:p-8 rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 group border border-gray-100"
              >
                ...
                <h3 className="text-lg xs:text-xl sm:text-2xl font-bold text-gray-900 mb-2 xs:mb-3 text-center">{item.title}</h3>
                <p className="text-gray-800 text-sm xs:text-base sm:text-lg font-semibold text-center">{item.info}</p>
                <p className="text-gray-600 text-xs xs:text-sm sm:text-base text-center mt-1 xs:mt-2">{item.subInfo}</p>
              </motion.a>
            ))}
          </motion.div>
        </div>
      ...
      <section id="contact-form" className="py-12 xs:py-16 sm:py-20 md:py-28 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-6xl mx-auto px-4 xs:px-5 sm:px-8 lg:px-10">
          <motion.div
            initial="hidden"
            whileInView="visible"
          ...
          <div className="grid lg:grid-cols-2 gap-8 xs:gap-10 lg:gap-16 items-start">
                ...
                <form onSubmit={handleSubmit} className="space-y-5 xs:space-y-6">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={handleChange}
                      required
                      rows="4" // Adjusted for better mobile view
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#FF5252] text-white px-6 xs:px-8 py-4 xs:py-5 rounded-xl text-base xs:text-lg sm:text-xl font-bold shadow-xl hover:bg-[#e63946] transition-all duration-300 hover:scale-105 active:scale-95"
                  >
                    Send Message
                  </button>
                </form>
            ...
            >
              {/* Google Maps */}
              <div className="rounded-3xl overflow-hidden shadow-2xl h-56 xs:h-64 sm:h-80 lg:h-[320px]">
                <iframe
              ...
              {/* Social Media */}
              <div className="bg-gradient-to-br from-[#FF5252] to-[#e63946] p-6 xs:p-8 rounded-3xl shadow-xl text-white">
                <h3 className="text-xl xs:text-2xl sm:text-3xl font-bold mb-5 xs:mb-6">Follow Us</h3>
                <div className="flex gap-4 xs:gap-5">
                  {[
                    ...
                    <a
                      key={i}
                      href={social.link}
                      className="w-12 xs:w-14 h-12 xs:h-14 bg-white/20 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-white hover:text-[#FF5252] transition-all duration-300 hover:scale-110 group"
                    >
      ...
      <section className="py-12 xs:py-16 sm:py-20 bg-white">
        <div className="max-w-5xl mx-auto px-4 xs:px-5 sm:px-8 lg:px-10 text-center">
          ...
          >
            <a
              href="/register"
              className="inline-block bg-[#FF5252] text-white px-8 xs:px-10 sm:px-12 py-4 xs:py-5 sm:py-6 rounded-2xl text-base xs:text-lg sm:text-xl font-bold shadow-xl hover:bg-[#e63946] transition-all duration-300 hover:scale-105 active:scale-95 animate-pulse-slow"
            >
